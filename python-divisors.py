...
#the for loop iterates through the algorithim in the given order
#using the range of 1000 to 10000 and then stops
#range funtion used to set numbering start and end point

#this range starts at 1000, stops at but does not include 10000
#stepping/incrementing in 1
...
#same as line 12 except comparision operator !=0
